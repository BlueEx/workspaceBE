...
AbstractDao<DigitacionExpressMapper> implements DigitacionExpressDao {
	...
	public CabeceraAgrupacionTO obtieneCabeceraAgrupacion(final long codigo)
		...
		final CabeceraAgrupacionTO cabeceraTO = new CabeceraAgrupacionTO();
		cabeceraTO.setCodigoAgrupacion((String) params.get(CODIGO_AGRUPACION));
		cabeceraTO.setCodigoEmpresa(Util.validaLong((Long) params
				.get(CODIGO_EMPRESA)));
		cabeceraTO.setCantidadDctosEstimados(Util.validaLong((Long) params
				.get(CANTIDAD_DOCTOS_ESTIMADOS)));
		cabeceraTO.setCantidadDoctosDigitados(Util.validaLong((Long) params
				.get(CANTIDAD_DOCTOS_DIGITADOS)));
		cabeceraTO.setCodigoUsuario(Util.validaLong((Long) params
				.get(CODIGO_USUARIO)));
		cabeceraTO.setFechaCreacion((Date) params.get(FECHA_CREACION));
		cabeceraTO.setFechaCierre((Date) params.get(FECHA_CIERRE));
		cabeceraTO.setCodigoEstado((String) params.get(CODIGO_ESTADO));
		cabeceraTO
				.setDescripcionEstado((String) params.get(DESCRIPCION_ESTADO));
		cabeceraTO.setTipoBulto((String) params.get(TIPO_BULTO));
		cabeceraTO
				.setCodigoRuta((Integer) params.get(CODIGO_RUTA));
		...
		cabeceraTO
				.setDescripcionSorter((String) params.get(DESCRIPCION_SORTER));
